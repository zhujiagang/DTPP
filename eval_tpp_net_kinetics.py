...
net_weights = "/home/lilin/my_code/ucf101_split_3_rgb_flow_models/ucf101_split_3_rgb_tpp_kinetics_st_0.01_lr_0.0001_iter_1500.caffemodel"
memory_enough = False
...
if dataset == 'ucf101':
    frame_path = "/home/lilin/UCF-101-result/"
else:
...
net_proto = relative_path + "/deeptemporal/models/"+ dataset + "/" + modality + "_kinetics_tpp_p124_deploy.prototxt"
...
# save_scores = 'ucf101_split_1_flow_tpp_p1248_lr_0.00001_iter_1200'
...
### UCF101
# save_scores = 'ucf101_split_1_rgb_tpp_kinetics_lr_0.0001_iter_1200'   ### 93.02%
# save_scores = 'ucf101_split_1_flow_tpp_kinetics_lr_0.0001_iter_600' ## 94.50%
...
# save_scores = 'ucf101_split_3_rgb_tpp_kinetics_lr_0.0001_iter_300' ### 92.92%
# save_scores = 'ucf101_split_3_flow_tpp_kinetics_lr_0.0001_iter_1800' ### 96.85%
save_scores = 'ucf101_split_3_rgb_tpp_kinetics_st_0.01_lr_0.0001_iter_1500' ### 93.39%


######
# save_scores = 'ucf101_split_1_rgb_tpp_kinetics_lr_0.0001_iter_1200'   ### 93.02%
# save_scores = 'ucf101_split_1_flow_tpp_kinetics_st_0.001_lr_0.0001_iter_900' ### 95.6%

# save_scores = 'ucf101_split_2_rgb_tpp_kinetics_st_0.001_lr_0.00001_iter_600' ### 93.81%
# save_scores = 'ucf101_split_2_flow_tpp_kinetics_st_0.001_lr_0.0001_iter_600' ### 97.39%


# save_scores = 'ucf101_split_3_rgb_tpp_kinetics_lr_0.0001_iter_300' ### 92.92%
save_scores = 'ucf101_split_3_rgb_tpp_kinetics_st_0.01_lr_0.0001_iter_1500' ### 93.39%
#  save_scores = 'ucf101_split_3_flow_tpp_kinetics_st_0.001_lr_0.00001_iter_300' ### 97.08%


#### HMDB51

# save_scores = 'hmdb51_split_1_rgb_tpp_kinetics_lr_0.00001_iter_336' ### 71.90%
# save_scores = 'hmdb51_split_1_flow_tpp_kinetics_lr_0.0001_iter_112' ### 80.20%
# save_scores = 'hmdb51_split_2_rgb_tpp_kinetics_snapshot_lr_0.00001_iter_224' ### 68.63%
# save_scores = 'hmdb51_split_2_flow_tpp_kinetics_lr_0.00001_iter_224'  ### 79.02%
# save_scores = 'hmdb51_split_3_rgb_tpp_kinetics_lr_0.0001_iter_672'  ### 70.85%
# save_scores = 'hmdb51_split_3_flow_tpp_kinetics_lr_0.00001_iter_224'  ### 79.02%

# save_scores = 'hmdb51_split_3_flow_tpp_kinetics_st_0.001_lr_0.0001_iter_336'  ### 78.69%
