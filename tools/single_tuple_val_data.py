...
if __name__ == '__main__':
    ...
    file_txt = "/home/zhujiagang/temporal-segment-networks/tools/single_tuple_val_data_1.txt"
    file = open(file_txt, 'w')
    cnt = 0
    cnttotal = 0
    while 1:
        ...
        item_1_1 = item_1.split('/')[6]
        file_2 = open("/home/zhujiagang/shuffle-tuple/networks/train01_image_keys.txt")
        cntt = 0
        while 1:
            ...
            if iii_1 == item_1_1:
                ...
                iii_a = line2.split('\t')[0]
                iii_a = int(iii_a.split('avi_0')[1])
                iii_b = line2.split('\t')[1]
                iii_b = int(iii_b.split('avi_0')[1])
                iii_c = line2.split('\t')[2]
                iii_c = int(iii_c.split('avi_0')[1])

                if iii_c >= iii_b and iii_b >= iii_a:
                    label = 0
                elif iii_c <= iii_b and iii_b <= iii_a:
                    label = 0
                else:
                    label = 1
                file.write(str(iii_a) + ' ' + str(iii_b) + ' ' + str(iii_c) + ' ' + str(label) + ' ')
