...
if __name__ == '__main__':
    ...
    file_txt = "/home/zhujiagang/temporal-segment-networks/data/ucf_val_1_image_lists.txt"
    file = open(file_txt, 'w')
    cnt = 0
    while 1:
        ...
        if t5  in item_1:
            for i in range(int(item_2)):
                file.write(item_1 + '/img_{:05d}.jpg'.format(i+1) + ' ' +item_3)
                cnt +=1
                file.write('\n')
            #cnt +=1
